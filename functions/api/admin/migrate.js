export async function onRequestGet({ request, env }) {
  ...
  try {
    ...
    const columns = [
      ...
      "profile_music_url_p2 TEXT DEFAULT ''",
      "profile_music_url_p3 TEXT DEFAULT ''",
      "profile_music_url_p4 TEXT DEFAULT ''",
      "profile_music_url_p5 TEXT DEFAULT ''",
      "banner_url TEXT DEFAULT ''",
      "banner_url_p2 TEXT DEFAULT ''",
      "banner_url_p3 TEXT DEFAULT ''",
      "banner_url_p4 TEXT DEFAULT ''",
      "banner_url_p5 TEXT DEFAULT ''",
